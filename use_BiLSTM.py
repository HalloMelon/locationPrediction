...
features = data.drop(columns=['country','fullname', 'user_location','probability'])

# Prepare the data for LSTM
# Convert the text labels for 'country' to numerical values
label_encoder = LabelEncoder()
y = label_encoder.fit_transform(data['country'])

# Concatenate all features as strings for tokenization
